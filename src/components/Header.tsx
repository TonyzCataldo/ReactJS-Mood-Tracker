...
type HeaderProps = {
  nome: string | null;
  setNome: Dispatch<SetStateAction<string | null>>;
  imagem: string | null;
  setImagem: Dispatch<SetStateAction<string | null>>;
...
const Header = ({
  ...
  return (
    <header className="flex items-center w-[91.47%] max-w-[73.125rem]">
      <img src={logo}></img>
      ...
      <div
        className="absolute flex flex-col w-[91.47%] top-[88px] bg-white rounded-[0.5rem] px-4 py-3"
        style={{
          boxShadow: "0px 5px 8px 0px rgba(33, 33, 77, 0.16)",
        }}
      >
        <div className="flex flex-col gap-0.5 pb-3 border-b border-blue-100">
          <h3 className="font-RedditSans text-neutral-900 text-[1.125rem]/[120%] font-medium">
            {nome}
          </h3>
          <p className="font-RedditSans text-neutral-300 text-[0.938rem]/[140%] tracking-[-0.019rem]">
            {email}
          </p>
        </div>
        <button className="flex items-center py-3 gap-2.5 font-RedditSans text-neutral-900 text-[0.938rem]/[140%] tracking-[-0.019rem]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
        ...
        <button className="flex items-center gap-2.5 font-RedditSans text-neutral-900 text-[0.938rem]/[140%] tracking-[-0.019rem]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
